...
from relarena.core.cache import CacheConfig, resolve_cache_config
from relarena.core.dataset import TaskSource, concat_tables
...
from relarena.core.search_space import TaskStats, resolve_search_space
from relarena.core.selection import select_best
from relarena.core.system import RelArenaSystem
from relarena.core.tuner import tune as run_tuning
from relarena.core.userdb._schema import load_schema, validate
from relarena.core.userdb.ingest import DatabaseSpec, build_dataset
from relarena.core.userdb.predict import EntitySelector, predict_at
...
class PredictiveQuery:
    ...
    def fit(
        ...
        *,
        ...
        no persistent cache when that variable is unset. See `relarena.core.cache`.
        """
