...
from relarena.core.cache import CacheConfig, cache_key
from relarena.core.featurization.cache import cached_frame
...
def build_dfs_features(
    ...
    *,
    ...
    # scope they make `relarena.core.featurization` unimportable without the extra,
